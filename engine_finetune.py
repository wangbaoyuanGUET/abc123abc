...
def compute_metrics_multiclass(probs, preds, targets, nb_classes):
    ...
    auroc = AUROC(task='multiclass', average='macro', num_classes=nb_classes)
    ...
    speci = Specificity(task='multiclass', average='macro', num_classes=nb_classes)
    print("nb_classes:", nb_classes)
    print("preds shape:", preds_tensor.shape, "dtype:", preds_tensor.dtype)
    print("targets shape:", targets_tensor.shape, "dtype:", targets_tensor.dtype)
